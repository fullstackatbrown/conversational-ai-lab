...
const navigation = [
  ...
  { name: 'Our Team', href: 'https://nextjs.org/learn/basics/navigate-between-pages/link-component', current: false },
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current ? 'bg-gray-900 text-black' : 'text-black hover:bg-gray-300 hover:text-black',
            ...
            <div className="space-y-1 px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-gray-300 text-black' : 'text-black hover:bg-gray-300 hover:text-black',
