...
export default function ProfilePage() {
  ...
  useEffect(() => {
    if (user) {
      getUserData(user.uid).then((data: UserData) => {
        setProfData(data);
      ...
      {!editMode ? (
        <div className="w-5/6  mx-auto">
          <div className="h-[150px] flex flex-row gap-[31px]">
            <img
              className="h-[250px] w-[250px] rounded-full border-solid border-[10px] border-white relative bottom-[100px]"
            ...
            <div className="flex flex-col grow">
              ...
              <p className="text-[22px] h-[36px] font-semibold mt-[13px]">
                {" "}
                Brown University{" "}
              </p>
          ...
          <div className="{ml-[5px] mt-[32px]">
            ...
            <p className="text-[18px] ml-[5px] mt-[11px]">{bio}</p>
          </div>
        </div>
      ) : (
        <div className="flex flex-col lg:h-[105vh] h-[105vh]">
          <div className="flex flex-col items-start w-full pl-[200px] pt-10 pb-6">
            {" "}
            {/* Adjust padding and margin */}
            <h1 className="lg:text-3xl font-bold text-black font-inter">
              Edit Profile
            </h1>
          </div>
